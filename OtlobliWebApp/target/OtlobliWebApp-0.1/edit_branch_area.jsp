...
<%
       if(rememberUserName != "" || !rememberUserName.equals("")) {
        %>
        <br><br><br>
<h1 style="color:gold;"><%="Welcome" + "  " +rememberUserName +"where you can edit branch area "%></h1>
...
%>
<br><br><br>
<h1 style="color:gold;">Welcome <%=userName%> where you can edit branch area</h1>
...
<html>
   ...
   <jsp:include page="header_all.jsp" />
        ...
        <form action="EditBranchServlet" method="post"  accept-charset="ISO-8859-1">
          <input type="text" class="form-control" hidden readonly id="id"  value="false" name="flag" >
            <div class="form-group">
                <label for="id">Area id</label>
                <input type="text" class="form-control" id="id" readonly value="<%=areaId%>" name="areaId" >
            </div>
            <div class="form-group">
