...
<html>
    ...
    <body>
        ...
        <form action='EditProductImage'method="post" enctype="multipart/form-data" accept-charset="ISO-8859-1">

            <input class="form-control" required hidden readonly type="text" name="providerId" value="<%=providerId%>"/>



            <input class="form-control" required hidden readonly  type="text" name="catid" value="<%=categoryId%>"/>



            <input class="form-control" id="id" required hidden readonly  type="text" name="id" value="<%=productId%>"/>
            ...
            <input class="form-control"id="name_ar_product"  required hidden readonly   required type="text" name="name_ar_product" value="<%=productBean.getNameAr()%>"/>




            <input class="form-control" id="name_en_product"  required hidden readonly  type="text" name="name_en_product" value="<%=productBean.getNameEn()%>"/>




            <textarea class="form-control" id="name_ar_desc_product"  required hidden readonly  rows="5" required name="name_ar_desc_product"  ><%=productBean.getDescriptionAr()%></textarea>
            ...
            <textarea class="form-control" id="name_en_desc_product"  required hidden readonly  rows="5" required name="name_en_desc_product"  ><%=productBean.getDescriptionEn()%></textarea>



            <div class="form-group">
                <label for="logo">Pic</label>
                <img src="images/<%=productBean.getImagePath()%>" id="logo" width="100" height="100"/>
            </div>


            <select name="categories"  required hidden readonly   class="form-control" id="categories">
            ...
            <select  required hidden readonly  name="status" required class="form-control" id="status">
                <option
                ...
                <input type="number" required hidden readonly step="any" id="price" value="<%=productBean.getPrice()%>" required class="form-control" id="fees" name="price" placeholder="type price">
            ...
            <div class="form-group">
                ...
                <input class="form-control" required id="logo" type="file" required name="logo" />
            </div>

            <div class="form-group">

                <button class="btn btn-primary" type="submit" onclick="if (confirm('Are you sure you want to edit the image ?')) {
                            return true
                        } else {
                            return false
