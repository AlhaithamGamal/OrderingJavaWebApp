...
<html>
    <head>
        ...
        <title>View provider and branches users</title>
    </head>
    <body>
        ...
        <br> <br> <br> 
        <h1>Provider and branches users</h1>
        <table  class="table table-hover" border='1' width='100%'>
            <tr>
                <th scope="col">ProviderUserID</th>
                <th scope="col">Provider username</th>
                <th scope="col">Provider email</th>
                <th scope="col">Provider username password</th>
                  <th scope="col">Provider username encrypted_password</th>
                <th scope="col">Is active ?</th>
                <th scope="col">Provider username branch </th>
                ...
                <c:choose> 
                    <c:when test="${iProviderUserBean.branch != null}">
                        <tr>
                            ...
                            <td> <c:out value="${iProviderUserBean.branch.nameEn}"/> </td>

                            <td> 
                                <a href="edit_provider_user.jsp?id=${iProviderUserBean.id}&providerId=${providerId}"class="btn btn-primary btn-lg active" role="button" aria-pressed="true"onclick="if (confirm('Are you sure you want to edit the record ?')) {
                                    return true
                                } else {
                                    return false
                                }">Edit provider user details</a>
                            </td>

                            <td> 
                                <a href="DeleteProviderUserServlet?id=${iProviderUserBean.id}&providerId=${providerId}&flag=false" onclick="if (confirm('Are you sure you want to delete the record ?')) {
                                    return true
                                } else {
                                    return false
        ...
        <a href='add_provider_user.jsp?providerId=${providerId}' class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Add new provider user</a>
    </body>
</html>
.