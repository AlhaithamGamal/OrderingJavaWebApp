...
<html>
    ...
    <body>
        ...
        <form action='EditCategoryServlet'method="post" enctype="multipart/form-data" accept-charset="ISO-8859-1">
            ...
            <div class="form-group">
                ...
                <input class="form-control" required readonly id="id" type="text" name="id" value="<%=categoryId%>"/>
            </div>
            ...
            <div class="form-group">
                <label for="name_ar_cat">Name AR</label>
                <input class="form-control" id="name_ar_cat" required type="text" name="name_ar_cat" value="<%=categoryBean.getNameAr()%>"/>
            </div>

            <div class="form-group">
                <label for="name_en_cat">Name EN</label>
                <input class="form-control" id="name_en_cat" required type="text" name="name_en_cat" value="<%=categoryBean.getNameEn()%>"/>
            </div>

            <div class="form-group">
                <label for="name_ar_desc_cat">Description AR</label>
                <textarea class="form-control" id="name_ar_desc_cat" rows="5" required name="name_ar_desc_cat"  ><%=categoryBean.getDescriptionAr()%></textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="name_en_desc_cat" rows="5" required name="name_en_desc_cat"  ><%=categoryBean.getDescriptionEn()%></textarea>
            </div>
