...
%>
<br><br><br>
<h1 style="color:gold;"><%="Welcome" + "  " + rememberUserName + "where you can add product"%></h1>
...
%><br><br><br>
<h1 style="color:gold;">Welcome <%=userName%>  where you can add product</h1>
...
<html>
    ...
    <body>
        ...
        <form action="SaveProductServlet"  method="post" enctype="multipart/form-data"  accept-charset="ISO-8859-1">  
            ...
            <div class="form-group">
                ...
                <input class="form-control" id="category_name" required readonly type="text" name="category_name" value="<%= categoryBean.getNameEn()%>"/>
            </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control" id="name_ar_product" required type="text" name="name_ar_product"/>
            </div>


            <div class="form-group">
                <label for="name_en_product"> Name EN</label>
                <input class="form-control" id="name_en_product" required type="text" name="name_en_product"/>
            </div>

            <div class="form-group">
                <label for="name_ar_desc_product"> Description AR</label>
                <textarea class="form-control" id="name_ar_desc_product" rows="5" required name="name_ar_desc_product" ></textarea>
            </div>

            <div class="form-group">
                <label for="name_en_desc_product">Description EN</label>
                <textarea class="form-control" id="name_en_desc_product" rows="5" required name="name_en_desc_product" ></textarea>
            </div>


            <div class="form-group">
                <label for="price">Price($)</label>
                <input type="number" step="any"  required class="form-control" id="price" name="price" placeholder="type price">
            </div>

            <div class="form-group">
                <label for="status">Is Available ?</label>

                <select name="status" id="status" required class="form-control" id="status">
