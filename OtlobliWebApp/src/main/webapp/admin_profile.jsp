<%-- 
    ...
    Created on : Feb 29, 2020, 9:30:10 PM
    Author     : HaithamGamal
--%>
...
<%
       if(rememberUserName != "" || !rememberUserName.equals("")) {
        %>
        <br><br><br>
<h1 style="color:gold;"><%="Welcome" + "   "+rememberUserName%></h1>
...
%>
<br><br><br>
<h1 style="color:gold;">Welcome <%=userName%></h1>
...
<html>
    ...
    <body>
        ...
        <jsp:include page="header_all.jsp" />
         <% //for clearing cashe and preventing logout
