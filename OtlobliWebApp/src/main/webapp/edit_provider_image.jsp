...
<html>
    ...
    <body>
        ...
        <form action='EditProviderImage'method="post" enctype="multipart/form-data" accept-charset="ISO-8859-1">


            <input  type="text" hidden readonly  name='id' value="<%=p.getId()%>" required hidden readonly class="form-control" >



            <input type="text" hidden required readonly  class="form-control" id="name_ar_provider" name='name_ar_provider'value="<%=p.getNameAr()%>">

            <input type="text" hidden required  readonly  class="form-control" id="name_en_provider" name='name_en_provider' value="<%=p.getNameEn()%>">
            <input type="number" hidden readonly  class="form-control" id="hotline" name='hotline' value="<%=p.getHotline()%>">

            <img src="images/<%=p.getLogoPathEn()%>"  id="logo" width="100" height="100"/>


            <div class="form-group">
            

                <input class="form-control" readonly id="logo" required type="file" name="logo">
            </div>
