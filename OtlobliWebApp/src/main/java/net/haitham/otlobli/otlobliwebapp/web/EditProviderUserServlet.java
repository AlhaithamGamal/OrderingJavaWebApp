 ...
 * @author HaithamGamal
 */
@WebServlet(name = "EditProviderUserServlet", urlPatterns = {"/EditProviderUserServlet"})
public class EditProviderUserServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (providerUserBean2 != null) {
                ...
                response.sendRedirect("view_provider_users.jsp?s=" + updated + "&providerId=" + providerId);
