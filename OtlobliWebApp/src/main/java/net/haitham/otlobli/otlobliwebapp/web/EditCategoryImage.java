...
@WebServlet(name = "EditCategoryImage", urlPatterns = {"/EditCategoryImage"})
public class EditCategoryImage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            CategoryBean c = gateway.updateCategoryImage(categoryBean);
            if (c != null) {
                updated = true;
