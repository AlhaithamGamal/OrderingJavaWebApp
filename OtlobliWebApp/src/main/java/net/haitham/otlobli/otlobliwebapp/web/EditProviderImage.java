...
@WebServlet(name = "EditProviderImage", urlPatterns = {"/EditProviderImage"})
public class EditProviderImage extends HttpServlet {
        ...
        try  {
            ...
            /* TODO output your page here. You may use following sample code. */
              String nameAR = request.getParameter("name_ar_provider");
               System.out.println("NAME IS :"+nameAR);
            ...
            ProviderBean p = gateway.updateProviderImage(providerBean);
            if (p != null) {
                updated = true;
