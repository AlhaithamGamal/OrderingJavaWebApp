 ...
 * @author HaithamGamal
 */
@WebServlet(name = "DeleteProviderUserServlet", urlPatterns = {"/DeleteProviderUserServlet"})
public class DeleteProviderUserServlet extends HttpServlet {
...
OtlobliBLGateway gateway =(OtlobliBLGateway)appCon.getBean("otlobliBLGateway");
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.sendRedirect("view_provider_users.jsp?providerId=" + providerId);
