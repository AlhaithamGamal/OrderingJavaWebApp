...
OtlobliBLGateway gateway =(OtlobliBLGateway)appCon.getBean("otlobliBLGateway");
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        out.print("<form action='EditCountryServlet2' method='post'>");  
        out.print("<table>");  
        out.print("<tr><td></td><td><input type='hidden' name='id' value='"+c.getId()+"'/></td></tr>");  
        out.print("<tr><td>NameAR:</td><td><input type='text' name='nameAR' value='"+c.getNameAr()+"'/></td></tr>");  
        out.print("<tr><td>NameEN:</td><td><input type='text' name='nameEN' value='"+c.getNameEn()+"'/></td></tr>");
