 ...
 * @author HaithamGamal
 */
public class EditCountryServlet2 extends HttpServlet {
...
OtlobliBLGateway gateway =(OtlobliBLGateway)appCon.getBean("otlobliBLGateway");
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        countryBean.setId(Integer.parseInt(sid));
        countryBean.setNameAr(nameAR);
        countryBean.setNameEn(nameEN);
        
          
        CountryBean c=gateway.updateCountry(countryBean);;  
        if(c != null){ 
            updated=true;
           response.sendRedirect("countries.jsp?s2=" + updated);
        }else{  
